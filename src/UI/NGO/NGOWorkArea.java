...
public class NGOWorkArea extends javax.swing.JFrame {
    ...
    public NGOWorkArea() {
        try {
        System.out.println("Initializing NGO Work Area...");
        initComponents();
        
        // Additional setup if needed
        setLocationRelativeTo(null); // Center the window
        setTitle("NGO Work Area");
    } catch (Exception e) {
        System.out.println("Error initializing NGO Work Area: " + e.getMessage());
        e.printStackTrace();
        JOptionPane.showMessageDialog(this, "Error initializing NGO Work Area");
    }
    }
    ...
    private void initComponents() {
        ...
        btnDonorsList.setBounds(220, 240, 250, 50);
        ...
        btnPC.setBounds(230, 130, 250, 50);
